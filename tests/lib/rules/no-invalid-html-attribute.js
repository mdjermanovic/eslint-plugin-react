          ...
          suggestions: [
            {
              ...
              data: { reportingValue: 'noreferrer noopener   ' },
              output: '<a rel="noreferrer noopener"></a>',
            },
          ],
          type: 'Literal',
      ...
      errors: [
        {
          ...
          suggestions: [
            {
              messageId: 'suggestRemoveWhitespaces',
              data: { reportingValue: 'noreferrer\xa0\xa0noopener' },
              output: '<a rel="noreferrer noopener"></a>',
            },
          ],
          type: 'Literal',
      ...
      errors: [
        ...
        },
        {
          ...
          suggestions: [
            {
              messageId: 'suggestRemoveWhitespaces',
              data: { reportingValue: 'foobar batgo       noopener' },
      ...
      errors: [
        ...
        },
        {
          ...
          suggestions: [
            {
              messageId: 'suggestRemoveWhitespaces',
              data: { reportingValue: ' batgo noopener' },
              output: '<a rel={"batgo noopener"}></a>',
            },
          ],
        },
      ...
      errors: [
        {
          ...
          suggestions: [
            {
              messageId: 'suggestRemoveWhitespaces',
              data: { reportingValue: 'shortcut  icon' },
      ...
      errors: [
        ...
        },
        {
          ...
          suggestions: [
            {
              messageId: 'suggestRemoveWhitespaces',
              data: { reportingValue: 'shortcut  foo' },
